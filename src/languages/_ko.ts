...
변경을 제안하거나 사이트에 기여하여 저희를 돕고 싶다면 [Discord](https://discord.gg/A8MRq5Vuvt) 또는 계정이 있는 경우 [Portal](https://cms.symbol-community.com/admin/auth/login)을 통해 저희에게 연락하십시오.
